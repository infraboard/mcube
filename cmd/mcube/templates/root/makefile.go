...
install: ## Install depence go package
	...
	@go install github.com/infraboard/mcube/cmd/mcube@v1.1.5
	@go install github.com/infraboard/mcube/cmd/protoc-gen-go-ext@v1.1.5
	@go install github.com/infraboard/mcube/cmd/protoc-gen-go-http@v1.1.5
