...
var file_mcube_pb_example_test_proto_rawDesc = string([]byte{
	...
	0x03, 0x46, 0x4f, 0x4f, 0x12, 0x05, 0x0a, 0x01, 0x58, 0x10, 0x00, 0x42, 0x2b, 0x5a, 0x29, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x62,
	0x6f, 0x61, 0x72, 0x64, 0x2f, 0x6d, 0x63, 0x75, 0x62, 0x65, 0x2f, 0x76, 0x32, 0x2f, 0x70, 0x62,
...
var (
	...
	file_mcube_pb_example_test_proto_rawDescData []byte
)

func file_mcube_pb_example_test_proto_rawDescGZIP() []byte {
	file_mcube_pb_example_test_proto_rawDescOnce.Do(func() {
		file_mcube_pb_example_test_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mcube_pb_example_test_proto_rawDesc), len(file_mcube_pb_example_test_proto_rawDesc)))
	})
...
var file_mcube_pb_example_test_proto_goTypes = []any{
...
func file_mcube_pb_example_test_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mcube_pb_example_test_proto_rawDesc), len(file_mcube_pb_example_test_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
