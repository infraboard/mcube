...
const file_mcube_pb_example_test_proto_rawDesc = "" +
	"\n" +
	"\x1bmcube/pb/example/test.proto\x12\x18infraboard.mcube.example\"D\n" +
	"\x04Test\x12\x14\n" +
	"\x05label\x18\x01 \x01(\tR\x05label\x12\x12\n" +
	"\x04type\x18\x02 \x01(\x05R\x04type\x12\x12\n" +
	"\x04reps\x18\x03 \x01(\x03R\x04reps*\f\n" +
	"\x03FOO\x12\x05\n" +
	"\x01X\x10\x00B+Z)github.com/infraboard/mcube/v2/pb/exampleb\x06proto3"
