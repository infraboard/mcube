...
const file_mcube_pb_resource_visiable_proto_rawDesc = "" +
	"\n" +
	" mcube/pb/resource/visiable.proto\x12\x19infraboard.mcube.resource*1\n" +
	"\bVISIABLE\x12\r\n" +
	"\tNAMESPACE\x10\x00\x12\n" +
	"\n" +
	"\x06DOMAIN\x10\x01\x12\n" +
	"\n" +
	"\x06GLOBAL\x10\x02B,Z*github.com/infraboard/mcube/v2/pb/resourceb\x06proto3"

var (
	file_mcube_pb_resource_visiable_proto_rawDescOnce sync.Once
	file_mcube_pb_resource_visiable_proto_rawDescData []byte
)

func file_mcube_pb_resource_visiable_proto_rawDescGZIP() []byte {
	file_mcube_pb_resource_visiable_proto_rawDescOnce.Do(func() {
		file_mcube_pb_resource_visiable_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_mcube_pb_resource_visiable_proto_rawDesc), len(file_mcube_pb_resource_visiable_proto_rawDesc)))
	})
...
var file_mcube_pb_resource_visiable_proto_goTypes = []any{
...
func file_mcube_pb_resource_visiable_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_mcube_pb_resource_visiable_proto_rawDesc), len(file_mcube_pb_resource_visiable_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
